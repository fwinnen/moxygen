...
| Members |                                              
|-----------------------------------------------------------------------------|
|`public bool `[`SetSuspension`](#classtransport_1_1MountainBike_1a04caecd7e5ff7572b6ac1dc283510301)`(double stiffness)`<div style="margin-top=4px; margin-left: 16px; font-style=italic;">Set suspension stiffness. @stiffness the suspension stiffness.</div>|
|`public template<>`  <br/>`inline bool `[`ChangeBreak`](#classtransport_1_1MountainBike_1afd02513876a196e98acaacdc555aeb52)`(BreakType breakType)`<div style="margin-top=4px; margin-left: 16px; font-style=italic;">Change the break type. @BreakType the break type. @breakType the type of the break.</div>|
